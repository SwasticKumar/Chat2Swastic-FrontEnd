    ...
    <Fragment>
      <section className="bg-gray-50 log-sign-bg">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
          ...
          <div className="w-full bg-white rounded-lg shadow-xl md:mt-0 md:max-w-xl sm:max-w-md  xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex flex-col md:flex-row md:justify-between gap-4">
                  <div className="w-full md:w-1/2">
                    ...
                    <input
                      ...
                      name="fname"
                      id="fname"
                      className=" border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#6c2fa8] focus:border-[#6c2fa8] block w-full p-2.5 "
                ...
                <div className="flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      ...
                      type="checkbox"
                      className="checkbox w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#57cbd1] "
                      required=""
                    />
                  </div>
                ...
                <p className="text-sm font-light text-gray-500">
                  ...
                  <Link
                    to="/"
                    className="font-medium text-[#0c0d77] hover:underline "
                  >
                    Login here
                  </Link>
                </p>
