...
const Header = () => {
    ...
    return (
        <Fragment>
            <div className="flex justify-between bg-[#6c2fa8] px-4 py-2 z-10">
            ...
            />
                ...
                <div className="flex items-center space-x-3 lg:space-x-8">
                    <div className="px-1 h-35">
                        <button onClick={() => setToggle(!toggle)}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 512 512" id="bell">
                                <path fill="#f1f5f9" d="M381.7 225.9c0-97.6-52.5-130.8-101.6-138.2 0-.5.1-1 .1-1.6 0-12.3-10.9-22.1-24.2-22.1-13.3 0-23.8 9.8-23.8 22.1 0 .6 0 1.1.1 1.6-49.2 7.5-102 40.8-102 138.4 0 113.8-28.3 126-66.3 158h384c-37.8-32.1-66.3-44.4-66.3-158.2zM256.2 448c26.8 0 48.8-19.9 51.7-43H204.5c2.8 23.1 24.9 43 51.7 43z">
                                </path>
                            </svg>
                        </button>
                    ...
                    <div className="dropdown dropdown-end dropdown-hover">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu p-2 shadow-xl bg-[#ffff] text-black rounded-box w-52">
