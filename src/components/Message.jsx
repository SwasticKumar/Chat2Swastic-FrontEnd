                                            ...
                                            <div className="flex w-full space-x-3 max-w-sm ml-auto justify-end">
                                                {
                                                    isSenderSingleMsg(messages, msg, i) || 
                                                        ...
                                                        (
                                                            <div className="bg-violet-400 text-white p-2 mt-1 ml-24 md:ml-0 rounded-l-[20px] rounded-r-[20px]">
                                                                <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                            </div>
                                                        ) : isSamesenderUpperMsg(messages, msg, i) ?
                                                            (
                                                                <div className="bg-violet-400 mt-1 text-white p-2 ml-24 md:ml-0 rounded-tr-[20px] rounded-br-md rounded-l-[20px]">
                                                                    <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                </div>
                                                            ) : isSamesenderLowerMsg(messages, msg, i) ?
                                                                (
                                                                    <div className="bg-violet-400 text-white p-2 ml-24 md:ml-0 rounded-l-[20px] rounded-br-[20px] rounded-tr-md">
                                                                        <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                    </div>
                                                                ) : (
                                                                    <div className="bg-violet-400 text-white p-2 ml-24 md:ml-0 rounded-l-[20px] rounded-r-md">
                                                                        <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                    </div>
                                                                )
                                                }
                                                ...
                                                (
                                                    <div className="flex w-full ml-[44px] space-x-3 max-w-[339px] mt-3 mr-24 md:mr-12" style={{
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="bg-white p-2 rounded-tl-[20px] rounded-bl-md rounded-r-[20px]">
                                                                <p className="text-sm px-3">{msg.content}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className='flex w-full space-x-3'>
                                                                <div className="flex-shrink-0 h-8 w-8 mt-auto rounded-full relative">
                                                                    <img className="object-cover w-8 h-8 rounded-full" src={msg.sender.photo} alt="Sender pic" />
                                                                    {
                                                                        onlineUsers.find((u) => u.userId === msg.sender._id)
                                                                        &&
                                                                        <span className="h-2 w-2 rounded-full bg-violet-500 absolute right-0.5 ring-2 ring-gray-300 bottom-0"></span>
                                                                    }
                                                                </div>
